...
import dev.neuralnexus.beenamegenerator.forge.commands.Forge_1_16_BNGCommand;
 ...
 */
//@Mod(Forge_1_16_BNGPlugin.MOD_ID)
public class Forge_1_16_BNGPlugin extends TemplateForgePlugin implements BeeNameGeneratorPlugin {
     ...
     */
    public Forge_1_16_BNGPlugin() {
        // Register server starting/stopping events
        MinecraftForge.EVENT_BUS.register(this);

        // Register commands
        MinecraftForge.EVENT_BUS.register(Forge_1_16_BNGCommand.class);
        pluginStart();
    }
