...
import dev.neuralnexus.beenamegenerator.forge.commands.Forge_1_20_BNGCommand;
 ...
 */
//@Mod(Forge_1_20_BNGPlugin.MOD_ID)
public class Forge_1_20_BNGPlugin extends TemplateForgePlugin implements BeeNameGeneratorPlugin {
     ...
     */
    public Forge_1_20_BNGPlugin() {
        // Register server starting/stopping events
        MinecraftForge.EVENT_BUS.register(this);

        // Register commands
        MinecraftForge.EVENT_BUS.register(Forge_1_20_BNGCommand.class);
        pluginStart();
    }
